...
import daiLogo from '../swap-bg.png';
import './App.css';
...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    const daiTokenAddress = "0x9EeA308398eB51B7Ef5262D2949Dda73a1367883" // Replace DAI Address Here
  ...
  render() {
    return (
      <div className="bg-image">
        <nav className="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow" style={{ height: "65px"}}>
          <a
          ...
          >
            KUANTI KRYTEX WALLET
          </a>
        </nav>
        <div className="container-fluid mt-5 contenedor">
          <div className="row">
            <main role="main" className="col-lg-12 d-flex text-center">
              <div className="content mr-auto ml-auto" style={{ width: "500px" }}>
                ...
                <h1 className="saldo">{this.state.balance}  SALDO MONEDA</h1>
                <form onSubmit={(event) => {
